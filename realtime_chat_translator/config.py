...
#For your main channel that you use for streaming
Twitch_Channel          = 'target_channel_name' 

#For your translation channel, twitch 2nd account
...
#change your translation language. Currently Japanese - English
lang_TransToHome        = 'ja'
lang_HomeToOther        = 'en'
...
Delete_Words            = ['stupid', 'idiot']

# Any emvironment, set it to `True`, then text will be read by TTS voice!
# TTS_In:User Input Text, TTS_Out:Bot Output Text
TTS_In                  = True
TTS_Out                 = True
TTS_Kind                = "gTTS" # You can choose "CeVIO" if you want to use CeVIO as TTS.
